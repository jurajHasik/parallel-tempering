...
!    *******************************************************************
	...
	INTEGER     NMAX, N
	PARAMETER ( NMAX = 125 )
! 		     Maximal number of atoms, Number of atoms
	REAL*8,     dimension(NMAX) :: RX, RY, RZ
...
!    ** CALCULATE INITIAL ENERGY AND CHECK FOR OVERLAPS **
        ...
        CALL SUMUP ( RMIN, SIGMA, OVRLAP, V, W, N )
...
!    *******************************************************************
        ...
        DO STEP = 1, NEQU
           ...
           CALL CYCLE ( N, SIGMA, DRMAX, V, W, VN, PRES, DENS, BETA, &
		     &TEMP, ACATMA, ACM, ACM1, ACV, ACP, ACVSQ, ACPSQ, &
		     &STEP, NEQU )
...
!          ** WRITE OUT RUNTIME INFORMATION **
              WRITE(*,'(2I8,4F12.6)') STEP, INT(ACM), VN, PRES, TEMP
           ENDIF
...
!    ** CHECKS FINAL VALUE OF THE POTENTIAL ENERGY IS CONSISTENT **
        ...
        CALL SUMUP ( RMIN, SIGMA, OVRLAP, VEND, WEND, N )
...
!    ** CALCULATE FLUCTUATIONS **
	...
	SUBROUTINE CYCLE ( N, SIGMA, DRMAX, V, W, VN, PRES, DENS, BETA, &
	& TEMP, ACATMA, ACM, ACM1, ACV, ACP, ACVSQ, ACPSQ, STEP, NEQU )
...
!    *******************************************************************	
	...
	REAL*8,	    dimension(NMAX) :: RX, RY, RZ
	REAL*8      SIGMA, DRMAX
	REAL*8      V, W, BETA, VN, PRES, DENS, TEMP
	REAL*8      ACATMA, ACM, ACM1, ACV, ACP, ACVSQ, ACPSQ
	INTEGER     STEP, NEQU
...
!          ** CALCULATE THE ENERGY OF I IN THE OLD CONFIGURATION **
              ...
              CALL ENERGY(RXIOLD,RYIOLD,RZIOLD,I,SIGMA,VOLD,WOLD, N )
...
!          ** CALCULATE THE ENERGY OF I IN THE NEW CONFIGURATION **
              ...
              CALL ENERGY(RXINEW,RYINEW,RZINEW,I,SIGMA,VNEW,WNEW, N )
...
!          *************************************************************
        ...
        SUBROUTINE SUMUP ( RMIN, SIGMA, OVRLAP, V, W, N )
...
!    ** LOOP OVER ALL THE PAIRS IN THE LIQUID **
        ...
        SUBROUTINE ENERGY ( RXI, RYI, RZI, I, SIGMA, V, W, N )
...
!   ********************************************************************
        ...
        SUBROUTINE WRITCN ( SAVEFILE, N, TEMP )
